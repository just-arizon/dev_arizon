...
function Navigation() {
  return (
    <div className='fixed bottom-0 bg-[#252525] w-full py-2 px-2 flex justify-between'>
      ...
      <ul className='social--wrapper flex '>
             ...
             <li className='list__item'>
              <button className='bg-transparent'>
                <a href='https://www.linkedin.com/in/arinze-calistus/' className='nav-icon'>
                             <Icon icon="line-md:linkedin" width="1.6em" height="1.6em" color='#fff'/>
                </a>
              </button>
              </li>
             <li className='list__item'>
              <button className='bg-transparent'>
                <a href='https://twitter.com/just_Arizon' className='nav-icon'>
                             <Icon icon="line-md:twitter" width="1.6em" height="1.6em" color='#fff'/>
                </a>
              </button>
              </li>
           </ul>
      ...
      width="1.6em" height="1.6em" color='#fff'/>
      </div>
    </div>
  )
}
